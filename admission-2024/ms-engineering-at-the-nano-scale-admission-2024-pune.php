...
<head>
    ...
    <title>Master of Science (M.S.) in Engineering at Nanoscale | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
...
<!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-11117162937"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-11117162937'); </script>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(6, 97, 99, 1)'>Call Us <span><a href='tel:9590300911'>+91-9590300911</a></span>
                    </p>
                </ul>
            </header>
        </div>
...
linear-gradient(0deg, rgba(6, 97, 99, 0.5) 0%, rgba(6, 97, 99, 0.5) 100%),
url("./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/hero_img.jpeg");
...
position: relative;'>
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        ...
                        <p class='second' style='font-size: 48px;'>Master of Science (M.S.) in Engineering at Nanoscale
                        </p>
                        <!-- <p class='second' style='font-size: 48px;'>M.S. (Engineering at the Nano-Scale) Under VU-Penn State University Collaboration   </p> -->
          ...
          <img src='global_img/UGC.png' alt='UGC'
            style='margin-left: -13px;' /> -->
                            <div class="note_text">
                                <p>Apply by JANUARY 31</p>
                                <p>(Fall Deadline) </p>
                            </div>
                            <p class="ms_deadline">Limited Seats Available</p>
...
padding: 30px 100px;'>
            <img src='global_img/M.S.(Engineering-at-the-Nano-Scale)_img/award.jpg' alt='award image'
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(6, 97, 99, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(6, 97, 99, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(6, 97, 99, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(6, 97, 99, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(6, 97, 99, 1)'>Programme Overview</h1>
            <p>The Master of Science (M.S.) in Engineering at the Nano-scale is a one-year degree programme offered in
                residence at the College of Engineering, University Park campus. It is a non-thesis degree programme
                allowing students to gain specific skills and knowledge applicable to their field of study.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/key_1.png" />
                        <p>One-Year Graduate Degree Programme as against a Two-Year Programme</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/key_2.png" />
                        <p>Save One Year's Tuition Fees & Living Costs (equivalent to USD 70,000)</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/key_3.png" />
                        <p> Improved Employability Chances</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(6, 97, 99, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/ph_1.png" />
            ...
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/ph_2.png" />
                    <h1 class="title">Non-Thesis MS Degree Programme</h1>
                    <p class="title_body">Fosters development of practical skills and real world application</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/ph_3.png" />
                    ...
                    <p class="title_body">A wide range of core courses to prepare you for a career in one of the most
                        rapidly growing and exciting field of nanoscience.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/ph_4.png" />
...
<div class="career_opportunity">
    <h1 style="color:rgba(6, 97, 99, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_1.png" />
                    <h1 class="title">Application/System Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_2.png" />
                    <h1 class="title">Device Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_3.png" />
                    <h1 class="title">Optical Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_4.png" />
                    <h1 class="title">Research Scientist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_5.png" />
                    <h1 class="title">Yield Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.S.(Engineering-at-the-Nano-Scale)_img/career_6.png" />
                    <h1 class="title">Characterisation Engineer</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(6, 97, 99, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(6, 97, 99, 1)">Life @ VU</h1>
