...
<head>
    ...
    <title>M.Sc. (Computer Science) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(199, 0, 57, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgb(199 0 57 / 50%) 0%, rgb(199 0 57 / 50%) 100%),
url("./global_img/M.Sc.(ComputerScience)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Master Your Programming Skills</p>
                        <p class='second' style='font-size: 48px;'>M.Sc.</p>
                        <p class='second' style='font-size: 48px;'>(Computer Science)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(199, 0, 57, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(199, 0, 57, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(199, 0, 57, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(199, 0, 57, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(199, 0, 57, 1)'>Course Overview</h1>
            <p>The programme advances students' knowledge, skills, and professional prospects through deeper theoretical
                understanding, specialized skills, and practical experiences tailored to specific areas within the field
                viz. leading teams, managing projects, and leveraging emerging technologies to develop cutting-edge
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.(ComputerScience)_img/key_1.png" />
                        <p>Hands-On Learning</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.(ComputerScience)_img/key_2.png" />
                        <p>Live Internships</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.(ComputerScience)_img/key_3.png" />
                        <p>Contemporary Teaching Pedagogies</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.(ComputerScience)_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(199, 0, 57, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Sc.(ComputerScience)_img/ph_1.png" />
                    <h1 class="title">Build Theory Knowledge</h1>
                    <p class="title_body">Possess profound knowledge of theory and principles of basic mathematics,
                        statistical techniques and algorithms in the field of computer science.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Sc.(ComputerScience)_img/ph_2.png" />
                    <h1 class="title">Design and Deploy Solutions</h1>
                    <p class="title_body">Develop the ability to think critically; select economically and technically
                        viable solutions to a given problem; design, develop and deploy solutions.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Sc.(ComputerScience)_img/ph_3.png" />
                    <h1 class="title">Build Interpersonal skills</h1>
                    <p class="title_body">Effectively communicate with diverse clients and stakeholders for software
                        project management along with interpersonal skills.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Sc.(ComputerScience)_img/ph_4.png" />
                    <h1 class="title">Adhere to Professionals</h1>
                    <p class="title_body">Work independently or as an effective team member of a software development
                        project and adhere to various professional practices.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(199, 0, 57, 1)">Career Opportunities</h1>
        ...
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_1.png" />
                    <h1 class="title">Data Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_2.png" />
                    <h1 class="title">Data Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_3.png" />
                    <h1 class="title">Data Scientist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_4.png" />
                    <h1 class="title">AI & Machine Learning Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_5.png" />
                    <h1 class="title">Game Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.(ComputerScience)_img/career_6.png" />
                    <h1 class="title">Multimedia Programmer</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(199, 0, 57, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(199, 0, 57, 1)">Life @ VU</h1>
