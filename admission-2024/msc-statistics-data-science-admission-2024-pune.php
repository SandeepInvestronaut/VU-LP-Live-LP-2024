...
<head>
    ...
    <title>MSc (Statistics – Data Science) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(63, 65, 114, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(63, 65, 114, 0.5) 0%, rgba(63, 65, 114, 0.5) 100%),
url("./global_img/M.Sc.Statistics(Data-Science)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Unveiling Insights, Empowering Innovation</p>
                        <!-- <p class='second' style='font-size: 48px;'>Master of Science</p> -->
                        <p class='second' style='font-size: 48px;'>MSc (Statistics – Data Science)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(63, 65, 114, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(63, 65, 114, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(63, 65, 114, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(63, 65, 114, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(63, 65, 114, 1)'>Programme Overview</h1>
            <p>The programme provides students with advanced knowledge, skills, and practical experience in the field of
                data science to extract insights, drive decision-making, and solve complex problems using data in
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.Statistics(Data-Science)_img/key_1.png" />
                        <p>Key Statistical Expertise </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.Statistics(Data-Science)_img/key_2.png" />
                        <p>Hands-on Experience</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.Statistics(Data-Science)_img/key_3.png" />
                        <p>Corporate Connect Through TCS iON (IHP)</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/M.Sc.Statistics(Data-Science)_img/key_4.png" />
                        <p> Industry Interactions and Opportunities</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(63, 65, 114, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/ph_1.png" />
                    <h1 class="title">Apply Skills to Real-World Problems</h1>
                    <p class="title_body">Apply rudimentary knowledge to provide statistical, mathematical and IT-based
                        solutions for data analysis and real-world problems. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/ph_2.png" />
                    <h1 class="title">Interpret and Draw Conclusions</h1>
                    <p class="title_body">Design and develop a solid grounding in statistics and data analytics tools.
                        Analyse, interpret and draw conclusions from data from an open-minded perspective. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/ph_3.png" />
                    <h1 class="title">Analyse - Evaluate - Adopt</h1>
                    <p class="title_body">Analyse, and evaluate the local and global impact of the statistical-based
                        solution on individuals, organisations, and society. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/ph_4.png" />
                    <h1 class="title">Ethical Communication</h1>
                    <p class="title_body">Follow ethical principles and commute to professional ethics, and effectively
                        communicate in their professional career.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(63, 65, 114, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_1.png" />
                    <h1 class="title">Data Scientist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_2.png" />
                    <h1 class="title">Data Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_3.png" />
                    <h1 class="title">Data Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_4.png" />
                    <h1 class="title">Business Intelligence Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_5.png" />
                    <h1 class="title">Statistical Programmer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/M.Sc.Statistics(Data-Science)_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(63, 65, 114, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(63, 65, 114, 1)">Life @ VU</h1>
