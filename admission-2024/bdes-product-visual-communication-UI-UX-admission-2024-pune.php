...
<head>
    ...
    <title>(B.Des.) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p>Call Us <span><a href='tel:9590300911'>+91-9590300911</a></span></p>
                </ul>
            </header>
        </div>
    </div>
...
linear-gradient(0deg, rgba(15 117 107 / 12%) 0%, rgba(15 117 107 / 25%) 100%), url("./global_img/B.Des_img/hero_bg_img.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Design Your Future</p>
                        <p class='second' style='font-size: 54px;'>Bachelor of Design</p>
                        <p class='second' style='font-size: 54px;'>(B.Des.)</p>
                        <p class='third'>4 Years | 8 Semesters</p>
        ...
        ?>
                            ...
                            function checkForm(event) {
                                ...
                                if (agreeCheckbox) {
                                    ...
                                    console.error("Checkbox with id 'formCheck1' not found.");
                                }
...
padding: 30px 100px;'>
            <img src='./global_img/award.png' alt='award image' style='max-width: 100%;mix-blend-mode: darken;margin: 0 auto;
    display: flex;
    width: 100%;'>
        </div>
    </div>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            ...
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>
                    ...
                    <div class='card slider_container' style="border: 1px solid #0f756b !important;">
                        <div class='card-body img_slider_container'>
                            <div class='marquee'>
                                <ul class='marquee-content' id='industry_slider'>
                                    <li>
        ...
        <div class='section_4'>
            ...
            <p>The programme is designed to equip students with the knowledge and
                skills necessary for a successful career in various design
                disciplines. The curriculum combines theoretical foundations with
                hands-on practical experiences to foster creativity, critical
                thinking, and a deep understanding of design principles.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/spc_1.png" />
                        <p>Visual
                            Communication Design</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/spc_2.png" />
                        <p>Product
                            Design</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/spc_3.png" />
                        <p>User
                            Experience Design</p>
                    </div>
                </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/key_0.png" />
                        <p>Internships
                            & Collaborations</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/key_1.png" />
                        <p>Hands-on
                            Experience</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/key_2.png" />
                        <p>Workshops
                            with Artisans</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/B.Des_img/key_3.png" />
                        <p>Industry
                            Exposures</p>
                    </div>
                </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/ph_1.png" />
                    <h1 class="title">Design
                        Thinking</h1>
                    <p class="title_body">Integration of methodologies to solve complex problems and address user needs.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/ph_2.png" />
                    <h1 class="title">Project-Based
                        Learning</h1>
                    <p class="title_body">Emphasis on real-world hands-on projects to develop practical skills.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/ph_3.png" />
                    <h1 class="title">Technology
                        Integration</h1>
                    <p class="title_body">Use of cutting-edge design tools and software relevant to the specific design
                        field.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/ph_4.png" />
                    <h1 class="title">Professional
                        Development</h1>
                    <p class="title_body">Networking and exposure within the design community by building strong design
                        portfolio showcasing the work and progression throughout the programme.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_1.png" />
                    <p class="title">Graphic
                        Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_2.png" />
                    <p class="title">Product
                        Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_3.png" />
                    <p class="title">User
                        Experience (UX) Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_4.png" />
                    <p class="title">Design
                        Consultant</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_5.png" />
                    <p class="title">Branding
                        & Marketing</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Des_img/career_6.png" />
                    <p class="title">Start
                        your own Design Firm</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="success_story_wrapper">
    <div class="container-fluid">
        <h1>Success
            Stories</h1>
        <div id="wrapper"><button id="prev"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                    viewBox="0 0 40 40" fill="none">
                    <mask id="mask0_245_1656" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40"
                        height="40">
                        <rect width="40" height="40" fill="#D9D9D9" />
                    </mask>
                    <g mask="url(#mask0_245_1656)">
                        <path
                            d="M26.6027 36.848L9.93604 20.1813L26.6027 3.51465L29.561 6.47298L15.8527 20.1813L29.561 33.8896L26.6027 36.848Z"
                            fill="#0F756B" />
                    </g>
                </svg></button><button id="next"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                    viewBox="0 0 40 40" fill="none">
                    <mask id="mask0_245_1656" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40"
                        height="40">
                        <rect width="40" height="40" fill="#D9D9D9" />
                    ...
                    <g mask="url(#mask0_245_1656)">
                        <path
                            d="M13.3973 36.848L30.064 20.1813L13.3973 3.51465L10.439 6.47298L24.1473 20.1813L10.439 33.8896L13.3973 36.848Z"
                            fill="#0F756B" />
                    </g>
                </svg></button>
            <div id="carousel">
                <div id="content"><img class="item" src="./global_img/B.Des_img/success_1.png" />
                    <img class="item" src="./global_img/B.Des_img/success_2.png" />
                    <img class="item" src="./global_img/B.Des_img/success_3.png" />

                    <img class="item" src="./global_img/B.Des_img/success_4.png" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="carousel_Testimonial">
                        <li class="card">
                            <div class="embed-responsive embed-responsive-16by9"><img
                                    src="./global_img/B.Des_img/tetstimonial_thubnail.png" alt="VU Campus"
                                    class="card-img-top image-fluid"
                                    onclick="playVideo('https://www.youtube.com/embed/lTnq1x9VtVY')"></div>
                        </li>
