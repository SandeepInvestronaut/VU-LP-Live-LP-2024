...
<head>
    ...
    <title>Master of Arts (Interior Design & Decoration) | Admissions Open For 2024-2025 | Vishwakarma University Pune
    </title>
...
linear-gradient(0deg, rgba(70, 17, 17, 0.5) 0%, rgba(70, 17, 17, 0.5) 100%),
url("./global_img/MA(Interior-Design-Decoration)_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Master Your Design Skills</p>
                        <p class='second' style='font-size: 60px;'>Master of Arts</p>
                        <p class='second' style='font-size: 60px;'>(Interior Design & Decoration)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='section_4'>
            ...
            <p>The programme educates and empowers students to become thoughtful, skilled, and ethically responsible
                interior designers to build environments and enhance the quality of life for individuals and
                communities. The programme prepares students for a senior, managerial roles in the design industry.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Interior-Design-Decoration)_img/key_1.png" />
                        <p>Live Projects</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Interior-Design-Decoration)_img/key_2.png" />
                        <p>Focus on Learning Outcomes</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Interior-Design-Decoration)_img/key_3.png" />
                        <p> Research & Experimentation</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Interior-Design-Decoration)_img/key_4.png" />
                        <p>Gain Expertise in Use of Technology</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/ph_1.png" />
                    <h1 class="title">Varied Career Options</h1>
                    <p class="title_body">Explore exciting career avenues in the Interior Design Business and engage in
                        further studies through doctoral research.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/ph_2.png" />
                    <h1 class="title">Acquire Skillsets</h1>
                    <p class="title_body">Obtain hands-on knowledge and skills by interfacing with different design
                        sectors.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/ph_3.png" />
                    <h1 class="title">Detailed Overview</h1>
                    <p class="title_body">Get a clear view of the overall working of the Interior Design Industry and
                        its various components.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/ph_4.png" />
                    <h1 class="title">Hands-On Industry Experience</h1>
                    <p class="title_body">Industrial Training and Internships to prepare you for industry challenges.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_1.png" />
                    <h1 class="title">Interior Space Designers</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_2.png" />
                    <h1 class="title">Furniture Designers</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_3.png" />
                    <h1 class="title">Residential Designer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_4.png" />
                    <h1 class="title">Production Design Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_5.png" />
                    <h1 class="title">Urban and Regional Planner</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Interior-Design-Decoration)_img/career_6.png" />
                    <h1 class="title">Design Engineering Manager</h1>
                </div>
            </div>
        </div>
    </div>
