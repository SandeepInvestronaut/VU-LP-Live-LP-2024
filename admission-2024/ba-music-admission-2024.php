...
<head>
    ...
    <title>Bachelor of Arts (Music) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(160, 83, 68, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(160, 83, 68, 0.5) 0%, rgba(160, 83, 68, 0.5) 100%),
url("./global_img/BA-music_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Make The World Groove To Your Rhythm </p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Arts</p>
                        <p class='second' style='font-size: 48px;'>(Music)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(160, 83, 68, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(160, 83, 68, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(160, 83, 68, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(160, 83, 68, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(160, 83, 68, 1)'>Programme Overview</h1>
            <p>The programme in association with the Lakshminarayana Global Centre of Excellence aims to provide
                students with a comprehensive understanding of music theory, history, performance, and composition.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-music_img/key_1.png" />
                        <p>Practical Training</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-music_img/key_2.png" />
                        <p>Global Approach </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-music_img/key_3.png" />
                        <p>Balanced Curriculum</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-music_img/key_4.png" />
                        <p>On-Campus Recording Studios</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(160, 83, 68, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/ph_1.png" />
                    <h1 class="title">Programme Designed by Legendary Music Icons</h1>
                    <p class="title_body">The programme emphasizes the Gurukul system of learning and is designed by the
                        Violin Icon Padmabhushan Dr. L Subramaniam and legendary Bollywood playback singer Kavita
                        Krishnamurti Subramaniam.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/ph_2.png" />
                    <h1 class="title">Global Elements Exposure</h1>
                    <p class="title_body">Equal emphasis on both Carnatic and Hindustani styles of music, rooted in
                        traditional Indian music with an emphasis on performance. Exposure to elements of global music:
                        African, Latin American, and European music.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/ph_3.png" />
                    <h1 class="title">International Opportunities</h1>
                    <p class="title_body">The curriculum includes classes in Sanskrit as well as foreign languages to
                        help students demonstrate and perform abroad. Opportunity to appear for the exams of Trinity
                        College of Music, London and undertake higher education in music at renowned music institutions
                        in the world like Berklee College of Music, Boston, etc.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/ph_4.png" />
                    <h1 class="title">State-of-the-Art Infrastructure</h1>
                    <p class="title_body">On-campus recording studios to learn audio/visual music technologies.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(160, 83, 68, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_1.png" />
                    <h1 class="title">Music Producer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_2.png" />
                    <h1 class="title">Composer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_3.png" />
                    <h1 class="title">Music Therapist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_4.png" />
                    <h1 class="title">Sound Recordists</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_5.png" />
                    <h1 class="title">Audio Engineers</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-music_img/career_6.png" />
                    <h1 class="title">Music Educator</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(160, 83, 68, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(160, 83, 68, 1)">Life @ VU</h1>
