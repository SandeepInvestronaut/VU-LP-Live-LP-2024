...
<head>
    ...
    <title>BBA-Computer Application | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(208, 72, 72, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(208, 72, 72, 0.5) 0%, rgba(208, 72, 72, 0.5) 100%),
url("./global_img/BBA-Computer-Application_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Gain Technical Skills With Managerial Knowledge</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Business Administration</p>
                        <p class='second' style='font-size: 48px;'>BBA-Computer Application</p>
    ...
    gap: 12px;' action='registerForm.php' method='POST' onsubmit='checkForm(event)'>
                            ...
                            <div class='form-group'>
                                <input type='text' class='form-control' id='number' maxlength='10'
                                    aria-describedby='number' placeholder='Phone Number' name='phone'
                                    oninput='handleInput("number")' onkeypress='return isNumberKey(event)'>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(208, 72, 72, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(208, 72, 72, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(208, 72, 72, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(208, 72, 72, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(208, 72, 72, 1)'>Programme Overview</h1>
            <p>The BBA (Computer Application) programme offers budding technocrats an insight into the world of
                computers, their applications and the latest developments in the industry, which are in sync with the
                business environment. The course combines business knowledge with proficiency in computer applications.
            </p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-Computer-Application_img/key_1.png" />
                        <p>Corporate Shadowing & Mentoring</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-Computer-Application_img/ph_2.png" />
                        <p>Corporate Interviews</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-Computer-Application_img/ph_2.png" />
                    ...
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-Computer-Application_img/ph_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(208, 72, 72, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-Computer-Application_img/ph_1.png" />
                    <h1 class="title">Theoretical Knowledge With Practical Application</h1>
                    <p class="title_body">The curriculum provides a conceptual grounding in computer usage and its
                        practical business applications. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-Computer-Application_img/ph_2.png" />
                    <h1 class="title">Technical Skills</h1>
                    <p class="title_body">Promote innovative, open-source technologies through personal and professional
                        responsibilities by developing adequate awareness about impact of technology on society and
                        ethical issues pertaining to ICT.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-Computer-Application_img/ph_3.png" />
                    <h1 class="title">Real-Time Problem Solving</h1>
                    <p class="title_body">Demonstrates recent technical and professional knowhow in the field of
                        applications to solve real time problems.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-Computer-Application_img/ph_4.png" />
                    <h1 class="title">Career Opportunities</h1>
                    <p class="title_body">Prepare students to build a successful career in Computer Science /
                        Information Technology with necessary business knowledge.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(208, 72, 72, 1)">Career Opportunities</h1>
        ...
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_1.png" />
                    <h1 class="title">Programmer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_2.png" />
                    <h1 class="title">Information System Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_3.png" />
                    <h1 class="title">Database Administrator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_4.png" />
                    <h1 class="title">System Administrator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_5.png" />
                    <h1 class="title">Software Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-Computer-Application_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(208, 72, 72, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(208, 72, 72, 1)">Life @ VU</h1>
