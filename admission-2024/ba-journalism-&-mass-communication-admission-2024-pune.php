...
<head>
    ...
    <title>Bachelor of Arts (Journalism and Mass Communication) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(197, 127, 30, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(197, 127, 30, 0.5) 0%, rgba(197, 127, 30, 0.5) 100%),
url("./global_img/BA(Journalism-Mass-Communication)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Step Into The World Of Media</p>
                        <!-- <p class='second' style='font-size: 46px;'>Bachelor of Arts</p> -->
                        <p class='second' style='font-size: 46px;'>Bachelor of Arts (Journalism and Mass Communication)
                        </p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(197, 127, 30, 1)'>Industry Connect</h1>
            <div class='row'>
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(197, 127, 30, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(197, 127, 30, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(197, 127, 30, 1)'>Programme Overview</h1>
            <p>The programme aims to cultivate well-rounded professionals who are critical thinkers, effective
                communicators, ethical practitioners, and active contributors to the media industry and society.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Journalism-Mass-Communication)_img/key_1.png" />
                        <p>Interdisciplinary Curriculum</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Journalism-Mass-Communication)_img/key_2.png" />
                        <p> Experiential Learning</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Journalism-Mass-Communication)_img/key_3.png" />
                        <p>Industry Connect </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Journalism-Mass-Communication)_img/key_4.png" />
                        <p>Modern Recording Studio</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(197, 127, 30, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/ph_1.png" />
                    <h1 class="title">International Syllabus Guideline</h1>
                    <p class="title_body">The syllabus is formulated on UNESCO guidelines.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/ph_2.png" />
                    <h1 class="title">Augmented Programme Structure</h1>
                    <p class="title_body">The syllabus is a fine blend of core, elective, audit, and foundation courses
                        designed to provide comprehensive skills.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/ph_3.png" />
                    <h1 class="title">An Experiential Learning Method</h1>
                    <p class="title_body">Well-equipped, audio-visual studio-based experiential learning enhances the
                        effectiveness of classical teaching-learning methods.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/ph_4.png" />
                    <h1 class="title">Expert Faculty</h1>
                    <p class="title_body">Expertise led by in-house faculty and augmented by visiting, guest, and
                        decorated adjunct faculty as well as accomplished professor emeritus. </p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(197, 127, 30, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_1.png" />
                    <h1 class="title">Journalist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_2.png" />
                    <h1 class="title">Public Relations Professional</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_3.png" />
                    <h1 class="title">Content Creator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_4.png" />
                    <h1 class="title">Media Planner</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_5.png" />
                    <h1 class="title">Radio Jockey</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA(Journalism-Mass-Communication)_img/career_6.png" />
                    <h1 class="title">Digital Marketer</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(197, 127, 30, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(197, 127, 30, 1)">Life @ VU</h1>
