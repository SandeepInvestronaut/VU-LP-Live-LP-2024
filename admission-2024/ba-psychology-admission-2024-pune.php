...
<head>
    ...
    <title>Bachelor of Arts (Psychology) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(17, 106, 123, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(17, 106, 123, 0.5) 0%, rgba(17, 106, 123, 0.5) 100%),
url("./global_img/BA-Psychology_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Discover The Science Behind The Human Mind</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Arts</p>
                        <p class='second' style='font-size: 48px;'>(Psychology)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(17, 106, 123, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(17, 106, 123, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(17, 106, 123, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(17, 106, 123, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(17, 106, 123, 1)'>Programme Overview</h1>
            <p>The programme is designed to provide students with a comprehensive understanding of the principles,
                theories, methods, and applications of psychology.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-Psychology_img/key_1.png" />
                        <p>Adaptive Curriculum</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-Psychology_img/key_2.png" />
                        <p> Research Oriented Academics</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-Psychology_img/key_3.png" />
                        <p>Hands-on-Experience </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA-Psychology_img/key_4.png" />
                        <p>Faculty with Field Experience</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(17, 106, 123, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/ph_1.png" />
                    <h1 class="title">Comprehensive Curriculum</h1>
                    <p class="title_body">Covers various areas of psychology, including developmental psychology, social
                        psychology, cognitive psychology etc.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/ph_2.png" />
                    <h1 class="title">Interdisciplinary Approach</h1>
                    <p class="title_body">Integration of concepts and perspectives from related fields such as
                        sociology, anthropology, neuroscience, and philosophy.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/ph_3.png" />
                    <h1 class="title">Experiential Learning</h1>
                    <p class="title_body">Practical experience of applying psychological concepts through volunteer
                        work, field placements, service-learning projects etc.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/ph_4.png" />
                    <h1 class="title">Faculty Support</h1>
                    <p class="title_body">Advising services, Career counselling, Research facilities and academic
                        support.</p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(17, 106, 123, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_1.png" />
                    <h1 class="title">Psychologist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_2.png" />
                    <h1 class="title">Counsellor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_3.png" />
                    <h1 class="title">Psychotherapist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_4.png" />
                    <h1 class="title">Human Resources Specialist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_5.png" />
                    <h1 class="title">Educational Psychologist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA-Psychology_img/career_6.png" />
                    <h1 class="title">Mental Health Assistant</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(17, 106, 123, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(17, 106, 123, 1)">Life @ VU</h1>
