...
<head>
    ...
    <title>Master of Arts (Journalism & Mass Communication) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(70, 17, 17, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(70, 17, 17, 0.65) 0%, rgba(70, 17, 17, 0.65) 100%),
url("./global_img/MA(Journalism -Mass-Communication)_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Level Up Your Media Game</p>
                        <p class='second' style='font-size: 46px;'>Master of Arts (Journalism & Mass Communication)</p>
                        <!-- <p class='second' style='font-size: 46px;'>MA (Journalism & Mass Communication)</p> -->
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(70, 17, 17, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(70, 17, 17, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(70, 17, 17, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(70, 17, 17, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(70, 17, 17, 1)'>Programme Overview</h1>
            <p>The programme aims to advance students' knowledge, skills, and professional prospects in the dynamic and
                multifaceted field of media and communication by preparing them for wide range of career paths while
                fostering a commitment to journalistic integrity, ethical communication practices, and societal impact.
            </p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Journalism -Mass-Communication)_img/key_1.png" />
                        <p>Industry Connect</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Journalism -Mass-Communication)_img/key_2.png" />
                        <p>Well-Equipped Audio Visual Studio</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Journalism -Mass-Communication)_img/key_3.png" />
                        <p> Placements & Internships</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/MA(Journalism -Mass-Communication)_img/key_4.png" />
                        <p>Centre of Excellence for Communication Development </p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(70, 17, 17, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/ph_1.png" />
                    <h1 class="title">UN-based curriculum</h1>
                    <p class="title_body">The Journalism syllabus is formulated based on UNESCO guidelines.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/ph_2.png" />
                    <h1 class="title">Expert Interactions</h1>
                    <p class="title_body">Regular interactions with Media Industry and Academic stalwarts.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/ph_3.png" />
                    <h1 class="title">On-Campus Exposure</h1>
                    <p class="title_body">The Masters in Mass Communication calls for an exchange of ideas and thoughts
                        through various media workshops, panel discussions and seminars along with study tours.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/ph_4.png" />
                    <h1 class="title">Hands-On Experiences</h1>
                    <p class="title_body">An excellent hands-on experience with modern audio-visual facilities for
                        training in print and electronic media (Media Labs, Studios) for a high level of practical
                        exposure. </p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(70, 17, 17, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_1.png" />
                    <h1 class="title">News Reporter</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_2.png" />
                    <h1 class="title">TV Anchor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_3.png" />
                    <h1 class="title">Public Relations Executive</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_4.png" />
                    <h1 class="title">Advertising Copywriter</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_5.png" />
                    <h1 class="title">Corporate Communications Executive</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/MA(Journalism -Mass-Communication)_img/career_6.png" />
                    <h1 class="title">Ad Film Director</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(70, 17, 17, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(70, 17, 17, 1)">Life @ VU</h1>
