...
<head>
    ...
    <title>B.Sc. Statistics (Data Science) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(0, 91, 65, 1)'>Call Us <span><a href='tel:9590300911'>+91-9590300911</a></span>
                    </p>
                </ul>
            </header>
        </div>
...
linear-gradient(0deg, rgba(0, 91, 65, 0.5) 0%, rgba(0, 91, 65, 0.5) 100%),
url("./global_img/B.Sc.Statistics(DataScience)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Build A Career In Data Science</p>
                        <p class='second' style='font-size: 48px;'>B.Sc. Statistics</p>
                        <p class='second' style='font-size: 48px;'>(Data Science)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(0, 91, 65, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(0, 91, 65, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(0, 91, 65, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(0, 91, 65, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(0, 91, 65, 1)'>Course Overview</h1>
            <p>The multifaceted programme equips students with the knowledge, skills, and tools referring to statistical
                science and its application to address real-world problems and to prepare for a promising professional
                life in the rapidly evolving field of data analytics. </p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc.Statistics(DataScience)_img/key_1.png" />
                        <p>Proficiency in Data Science Technologies</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc.Statistics(DataScience)_img/key_2.png" />
                        <p>Extract actionable insights from complex datasets</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc.Statistics(DataScience)_img/key_3.png" />
                        <p>Exposure to wide range of industries and domains </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc.Statistics(DataScience)_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(0, 91, 65, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/ph_1.png" />
                    <h1 class="title">Data Visualisation</h1>
                    <p class="title_body">Exposure to various softwares like R, Python, SAS (University Edition),
                        Visualization tools, and packages.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/ph_2.png" />
                    <h1 class="title">Real-World Problem Analysis</h1>
                    <p class="title_body">Analyse the real-world problem and identify the domain-specific requirements.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/ph_3.png" />
                    <h1 class="title">A pool of Open Electives</h1>
                    <p class="title_body">Students can choose from a variety of open electives in fields like Economics,
                        Psychology, Finance, Travel, and Tourism.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/ph_4.png" />
                    <h1 class="title">TCS iON- Industry Honour Program (IHP)</h1>
                    <p class="title_body">The academic-industry partnership between VU and TCS fosters statistical
                        thinking among students.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(0, 91, 65, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_1.png" />
                    <h1 class="title">Data Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_2.png" />
                    <h1 class="title">Actuary</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_3.png" />
                    <h1 class="title">Statistician</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_4.png" />
                    <h1 class="title">Biostatistician</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_5.png" />
                    <h1 class="title">Market Research Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Sc.Statistics(DataScience)_img/career_6.png" />
                    <h1 class="title">Financial Consultant</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(0, 91, 65, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(0, 91, 65, 1)">Life @ VU</h1>
