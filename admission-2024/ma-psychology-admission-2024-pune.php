...
<head>
    ...
    <title>Master of Arts (Psychology)| Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(104, 62, 0, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(104, 62, 0, 0.5) 0%, rgba(104, 62, 0, 0.5) 100%),
url("./global_img/MA-Psychology_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Exploring the Depths of Behavior and Cognition</p>
                        <p class='second' style='font-size: 63px;'>Master of Arts (Psychology)</p>
                        <!-- <p class='second' style='font-size: 63px;'>MA Psychology</p> -->
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(104, 62, 0, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid #683e00 !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(104, 62, 0, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(104, 62, 0, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(104, 62, 0, 1)'>Programme Overview</h1>
            <p>The programme aims to expose students to knowledge, skills and research relating to Clinical,
                Counselling, and Industrial Psychology allowing them to design and conduct psychological studies.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/spc_1.png" />
                        <p>Clinical Psychology</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/spc_2.png" />
                        <p>Counselling Psychology</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/spc_3.png" />
                        <p>Industrial Psychology</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/key_1.png" />
                        <p>Advanced Knowledge</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/key_2.png" />
                        <p>Research & Practice</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/key_3.png" />
                        <p>Professional Development</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MA-Psychology_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(104, 62, 0, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/ph_1.png" />
                    <h1 class="title">Adaptive Curriculum</h1>
                    <p class="title_body"> Appreciating individual preferences, and learning styles.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/ph_2.png" />
                    <h1 class="title">Active Learning Experience</h1>
                    <p class="title_body">Interactive Activities, Problem solving tasks, Technology Integration.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/ph_3.png" />
                    <h1 class="title">Networking</h1>
                    <p class="title_body"> With the professionals in the field of study to explore career pathways.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/ph_4.png" />
                    <h1 class="title">Career Advancement </h1>
                    <p class="title_body">Varied careers in mental health, research, education, business, government,
                        non-profit sectors etc.
                    </p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(104, 62, 0, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_1.png" />
                    <h1 class="title">Clinical Psychologist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_2.png" />
                    <h1 class="title">Psychotherapist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_3.png" />
                    <h1 class="title">Counsellor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_4.png" />
                    <h1 class="title">Industrial Psychologist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_5.png" />
                    <h1 class="title">Behaviour Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MA-Psychology_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(104, 62, 0, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(104, 62, 0, 1)">Life @ VU</h1>
