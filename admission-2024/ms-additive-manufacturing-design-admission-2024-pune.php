...
<head>
    ...
    <title>Master of Science (M.S.) in Additive Manufacturing & Design (AMD) | Admissions Open For 2024-2025 |
...
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "l0hzt7zise");
</script>

<body>
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5LHH63MK" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(38, 90, 92, 1)'>Call Us <span><a href='tel:9590300911'>+91-9590300911</a></span></p>
                </ul>
            </header>
        </div>
    </div>
...
linear-gradient(0deg, rgba(38, 90, 92, 0.5) 0%, rgba(38, 90, 92, 0.5) 100%),
url("./global_img/M.S.(Additive-Manufacturing-and-Design)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Make Your Mark Globally</p>
                        <p class='second' style='font-size: 48px;'>Master of Science (M.S.) in Additive Manufacturing &
                            Design (AMD)</p>
                        <!-- <p class='second' style='font-size: 48px;'>M.S. (Additive Manufacturing and Design)</p> -->
                        <p class='third'>1 Years | 2 Semesters</p>
            ...
            style='margin-left: -13px;' /> -->
                            ...
                            <div class="main_column">
                                <div class="first_column">
                                    <p>Apply by JANUARY 31
                                        (Fall Deadline)</p>
                                </div>

                                <div class="second_column">
                                    <p>Apply by SEPTEMBER 1
                                        (Spring Deadline) </p>
                                </div>
                            </div>
                            <p style="
...
">Limited Seats Available</p>
    ...
    gap: 12px;' action='registerForm.php' method='POST' onsubmit='checkForm(event)'>
                            <div class='form-group'>
                                <input type='text' class='form-control' id='name' aria-describedby='name' placeholder='Full Name' name='name' oninput='handleInput("name")'>
                                <p class='error-message' id='name-error' style='display:none;'></p>

                            </div>
                            <div class='form-group'>
                                <input type='email' class='form-control' id='email' aria-describedby='email' placeholder='Email' name='email' oninput='handleInput("email")'>
                                <p class='error-message' id='email-error' style='display:none;'></p>
                            </div>
                            <div class='form-group'>
                                <input type='number' class='form-control' id='number' aria-describedby='number' placeholder='Phone Number' name='phone' oninput='handleInput("number")' onkeyup="limitPhoneNumber(this, 10)" maxlength="10">
                            ...
                            <!-- <a href='https://docs.google.com/forms/d/e/1FAIpQLSfjxVkKl_fgEH6grVy6yNGMNriBXRQyjNAXVXUXeV3BvAZFXg/viewform'> 
                            <button type='submit' class='btn btn-primary' name='upload'>Fill Google Form</button>
    </a>  -->
                        </form>
...
padding: 30px 100px;'>
            <img src='global_img/M.S.(Additive-Manufacturing-and-Design)_img/award.jpg'' alt=' award image' style='max-width: 100%;mix-blend-mode: darken;margin: 0 auto;display: flex;width: 100%;'>
        </div>
    </div>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(38, 90, 92, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(38, 90, 92, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(38, 90, 92, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(38, 90, 92, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(38, 90, 92, 1)'>Programme Overview</h1>
            <p>The Master of Science (M.S.) in Engineering at the Nano-scale is a one-year degree programme offered in
                residence at the College of Engineering, University Park campus, requiring a Masters’ scholarly paper or
                thesis.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/key_1.png" />
                        <p>One-Year Graduate Degree Programme as against a Two-Year Programme</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/key_2.png" />
                        <p>Save One Year's Tuition Fees & Living Costs (equivalent to USD 70,000)</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/key_3.png" />
                        <p> Improved Employability Chances </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/key_4.png" />
                        <p>Application-Based Teaching</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(38, 90, 92, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/ph_1.png" />
                    <h1 class="title">International Collaboration</h1>
                    <p class="title_body">The VU-Penn State University collaboration offers the students the opportunity
                        to follow the curriculum of a university ranked in the top 6% of world-class universities (QS
                        World University Rankings, 2024).</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/ph_2.png" />
                    <h1 class="title">Thesis-Based Programme</h1>
                    <p class="title_body">Focuses on research and research methodologies.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/ph_3.png" />
                    <h1 class="title">Core Courses</h1>
                    <p class="title_body">A wide range of core courses to prepare you for a career in one of the most
                        rapidly growing and exciting field of Additive Manufacturing & Design.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/ph_4.png" />
                    <h1 class="title">Multidisciplinary Programme</h1>
                    <p class="title_body">Offers Elective Courses with the Core Courses to integrate knowledge from
...
<div class="career_opportunity">
    <h1 style="color:rgba(38, 90, 92, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_1.png" />
                    <h1 class="title">3D Print Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_2.png" />
                    <h1 class="title">Design Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_3.png" />
                    <h1 class="title">Modular Design Architect</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_4.png" />
                    <h1 class="title">Materials Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_5.png" />
                    <h1 class="title">Research Scientist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.S.(Additive-Manufacturing-and-Design)_img/career_6.png" />
                    <h1 class="title">Assembly Supervisor</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade videoModal" id="videoModal" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center"> <iframe id="videoIframe" width="400" height="350" src="" frameborder="0" allowfullscreen="" allow="autoplay" style="width: 100%;"></iframe> </div>
        </div>
    </div>
</div>
<script>
...
<div class="modal fade" id="videoModalSimple" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center"> <video width="320" height="240" controls id="simple_video" src=""></video> </div>
        </div>
    </div>
</div>
<script>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(38, 90, 92, 1)"> Why VU?</div>
                    <div class="body_title"> Vishwakarma University, Pune (VU) is a natural offshoot of the Vishwakarma
                        Group of Institutions’ educational legacy spanning over 40 years. It is an institution where
                        education is not a destination but a transformative journey. We commit to providing our students
                        with world-class education. Our academic collaboration with Penn State University, Pennsylvania,
                        USA, is our step towards unlocking the potential and opening limitless possibilities to our
                        students. Together, we shape our students to lead on the global stage.</div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="count">
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(38, 90, 92, 1)">Life @ VU</h1>
        <div class="vu_prev_next_container"><button id="vu_prev"><img src="global_img/life_of_vu_arrow.png"" style=" max-width: 100%;transform: rotate(180deg);" /></button><button id="vu_next"><img src="global_img/life_of_vu_arrow.png" style="max-width: 100%" /></button></div>

        <div id="wrapper">
            <div id="vu_carousel">
                <div id="vu_content" class="align-items-end"> <img src="global_img/life_of_VU_1.png" style="width: 330px;" />
                    <img src="global_img/life_of_VU_2.png" style="width: 330px;" /> <img width="100%" height="218px" src="./global_img/youtube_thunbnail.png" onclick='demo("https://www.youtube.com/embed/tcSp3Muuj0M")'></img>
                    <img src="global_img/life_of_VU_3.png" style="width: 330px;" /> <img src="global_img/life_of_VU_4.png" style="width: 330px;" /> <img src="global_img/life_of_VU_5.png" style="width: 330px;" />
                </div>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="VU_life" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center"> <iframe width="350" height="270" controls autoplay id="life_video" style="max-width:100%;width:100%;">
                </iframe> </div>
        </div>
    </div>
</div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-3 p-auto p-0">
                    <h4>Get in Touch With Us</h4><a href="tel:9590300911">+91-9590300911</a><br><a href="mailto:admissions@vupune.ac.in">admissions@vupune.ac.in</a><br>
                </div>
            </div>
        </div>
    </footer>
