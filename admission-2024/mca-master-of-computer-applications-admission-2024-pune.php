...
<head>
    ...
    <title>MCA | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
...
linear-gradient(0deg, rgb(151 90 94 / 50%) 0%, rgb(151 90 94 / 50%) 100%), url("./global_img/MCA_img/hero_img.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Power Up Your Potential</p>
                        <p class='second' style='font-size: 48px;'>Master of Computer Applications</p>
                        <p class='second' style='font-size: 48px;'>(MCA)</p>
...
width: 100%;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style="color:#985a5f">Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid #985a5f !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div style="background-color:#985a5f" class='package_box'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div style="background-color:#985a5f" class='recruiters_box'>
        ...
        <div class='section_4'>
            ...
            <h1 style="color:#985a5f">Programme Overview</h1>
            <p>The programme develops high quality IT professionals to take up varied roles in planning, designing and
                building complex commercial IT applications and systems.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/MCA_img/key_1.png" />
                        <p>Corporate Shadowing & Mentoring</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/MCA_img/key_2.png" />
                        <p>Contemporary Curriculum</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/MCA_img/key_3.png" />
                        <p>Internships and Projects</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/MCA_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:#985a5f">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/ph_1.png" />
                    <h1 class="title">Choice-Based Credit System (CBCS)</h1>
                    <p class="title_body">Offers flexibility and customisation to students</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/ph_2.png" />
                    <h1 class="title">Outcome-Based Education (OBE)</h1>
                    <p class="title_body">Focuses on application of knowledge and development of skills for successful
                        professional careers</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/ph_3.png" />
                    <h1 class="title">Blend of Theory & Practical</h1>
                    <p class="title_body">A perfect blend of academia, industry, and research with project-based
                        evaluation.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/ph_4.png" />
                    <h1 class="title">Co-curricular Learning Interactions</h1>
                    <p class="title_body">Talks, Conferences, Summits, Competitions, etc.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:#985a5f">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_1.png" />
                    <p class="title">Testing Professional</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_2.png" />
                    <p class="title">Full Stack Developer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_3.png" />
                    <p class="title">Software Consultant</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_4.png" />
                    <p class="title">Systems Developer/Engineer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_5.png" />
                    <p class="title">Web Designer and Developer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MCA_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:#985a5f"> Why VU?</div>
