...
<head>
    ...
    <title>Bachelor of Laws (LL.B) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
...
url("./global_img/LLB_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Pursue Your Passion For Law</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Laws (LL.B)</p>
                        <!-- <p class='second' style='font-size: 48px;'>LLB</p> -->
                        <p class='third'>3 Years | 6 Semesters</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='section_4'>
            ...
            <p>Bar Council of India, approved LLB Programme offers comprehensive understanding and skills to analyse
                complex legal issues, interpret statutes and case law, develop arguments based on legal principles and
                succeed in varied aspiring legal professions.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/LLB_img/key_1.png" />
                        <p>Moot Court Rooms for Mock Trials</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/LLB_img/key_2.png" />
                        <p>Advocacy Skill Training</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/LLB_img/key_3.png" />
                        <p>Clinical Legal Aid Center </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/LLB_img/key_4.png" />
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/ph_1.png" />
                    <h1 class="title">Application Orientated</h1>
                    <p class="title_body">Acquiring in-depth knowledge of law provisions, statutes, legal principles,
                        and doctrines relevant to given factual situations.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/ph_2.png" />
                    <h1 class="title">Practical Learning Approach</h1>
                    <p class="title_body">Providing legal advice and consultancy to corporate clients, individuals, and
                        government institutions.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/ph_3.png" />
                    <h1 class="title">Field visits and Case Studies</h1>
                    <p class="title_body">Frequent Industrial and Court visits to identify and interpret the findings
                        and learn the law in specific situations. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/ph_4.png" />
                    <h1 class="title">Distinguished Faculty</h1>
                    <p class="title_body">Regular guest lectures by and interactions with renowned professionals,
                        jurists, and legal luminaries across the globe.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_1.png" />
                    <h1 class="title">Corporate Lawyer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_2.png" />
                    <h1 class="title">Legal Counsel</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_3.png" />
                    <h1 class="title">HR Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_4.png" />
                    <h1 class="title">Corporate Policy Advisor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_5.png" />
                    <h1 class="title">Patent Officer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLB_img/career_6.png" />
