...
<head>
    ...
    <title>Master Of Laws | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(179, 19, 18, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(179, 19, 18, 0.5) 0%, rgba(179, 19, 18, 0.5) 100%),
url("./global_img/LLM_img/hero_img.png");
...
position: relative;'>
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Advance Your Legal Career</p>
                        <p class='second' style='font-size: 60px;'>Master of Laws</p>
                        <p class='second' style='font-size: 60px;'>LLM</p>
    ...
    gap: 12px;' action='registerForm.php' method='POST' onsubmit='checkForm(event)'>
                            ...
                            <div class='form-state-select'>
                                <select name="coursename" class="selectVal" id="coursename"
                                    oninput='handleInput("coursename")'>
                                    <option value="" disabled selected>Select Course Name</option>

                                    <option value="1292">LLM (Criminal Law)</option>
                                    <option value="1293">LLM (Business Law)</option>
                                    <option value="1294">LLM (IP & Tech Law)</option>
                                    <option value="1295">LLM (ADR Law)</option>
                                    <option value="1296">LLM (Cyber Law)</option>
                                </select>
                                <p class='error-message' id='coursename-error' style='display:none;'></p>
                            </div>

                            <script>
                            document.addEventListener("DOMContentLoaded", function() {
                                let hiddenInput = document.getElementById("cname");
                                let dropdown = document.getElementById("coursename");
        ...
        ?>
                            ...
                            function checkForm(event) {
                                ...
                                if (coursename.trim() === '') {
                                    document.getElementById('coursename-error').style.display = 'block';
                                    document.getElementById('coursename-error').innerHTML = 'Please select your course';
                                    isValid = false;
                                    event.preventDefault();
                                } else {
                                    document.getElementById('coursename-error').innerHTML = '';
                                    document.getElementById('coursename-error').style.display = 'none';
                                }
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(179, 19, 18, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(179, 19, 18, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(179, 19, 18, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(179, 19, 18, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(179, 19, 18, 1)'>Programme Overview</h1>
            <p>The LLM programme at Vishwakarma University offers students the opportunity to learn from expert faculty.
                The research-oriented rigorous academics enable the students to gain knowledge of the law and develop a
                research attitude.</p>
...
<div class="col-sm-6">
    <div class="card">
        <div class="card-body" style="">
            <p>Specialisations</p>
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/spc_1.png" />
                        <p>Criminal Law</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/spc_2.png" />
                        <p>Business Law</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/spc_3.png" />
                        <p>International Law & Arbitration</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/spc_4.png" />
                        <p>Cyber Law</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/spc_5.png" />
                        <p>IPR (Intellectual Property Rights) Laws</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-body" style="">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/key_1.png" />
                        <p>Specialized Subjects</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/key_2.png" />
                        <p> Live Projects</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/key_3.png" />
                        <p>Shadowing Opportunities</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/LLM_img/key_4.png" />
                        <p>Internships</p>
                    </div>
                </div>
            </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(179, 19, 18, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/ph_1.png" />
                    <h1 class="title">Research-Oriented Academics</h1>
                    <p class="title_body">Rigorous academic focus builds an investigative and meticulous approach
                        required for a career in law.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/ph_2.png" />
                    <h1 class="title">Analytical Thinking</h1>
                    <p class="title_body">Cultivate an analytical approach toward socio-legal problems.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/ph_3.png" />
                    <h1 class="title">Practical Legal Skills</h1>
                    <p class="title_body">Learn invaluable skills in critical evaluation, research, and presentation to
                        put into your practice. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/ph_4.png" />
                    <h1 class="title">Empathy & Ethics</h1>
                    <p class="title_body">Develop a well-rounded outlook on the functioning of legal machinery, empathy
                        for different sections of society, and high ethical standards.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(179, 19, 18, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_1.png" />
                    <h1 class="title">Research Assistant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_2.png" />
                    <h1 class="title">Legal Positions in PSUs</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_3.png" />
                    <h1 class="title">Law Professor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_4.png" />
                    <h1 class="title">Legal Associate</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_5.png" />
                    <h1 class="title">Legal Advisor</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/LLM_img/career_6.png" />
                    <h1 class="title">Own a Law Firm</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="testimonials">
    <h1 style="color:rgba(179, 19, 18, 1)">Testimonial</h1>
    <div class="testimonial-slider" style="padding-top: 20px;">
        <div id="carouselExampleControls">
            <div class="container-fluid">
                <div class="wrapper"><i id="left" class="fa-solid fa-angle-left" style="display:none;"></i>
                    <ul class="carousel_Testimonial">
                        <li class="card" style="background-color:rgba(179, 19, 18, 1)">
                            <div class="embed-responsive embed-responsive-16by9"><img
                                    src="./global_img/LLM_img/testimonial_thumbnail.png" alt="VU Campus"
                                    class="card-img-top image-fluid"
                                    onclick="playVideo('https://www.youtube.com/embed/B3Yz0TzOZxI')"></div>
                        </li>
                    </ul><i id="right" class="fa-solid fa-angle-right" style="display:none;"></i>
                </div>
            </div>
        </div>
    </div>
...
const carouselTestimonial = document.querySelector(".carousel_Testimonial");
const firstCardWidth = carouselTestimonial.querySelector(".card").offsetWidth;
const arrowBtns = document.querySelectorAll(".wrapper i");
const carouselChildrens = [...carouselTestimonial.children];
let isDragging = false,
    isAutoPlay = true,
    startX, startScrollLeft, timeoutId;
carouselTestimonial.classList.add("no-transition");
carouselTestimonial.scrollLeft = carouselTestimonial.offsetWidth;
carouselTestimonial.classList.remove("no-transition");
arrowBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
        carouselTestimonial.scrollLeft += btn.id == "left" ? -firstCardWidth : firstCardWidth;
    });
});
const dragStart = (e) => {
    isDragging = true;
    carouselTestimonial.classList.add("dragging");
    startX = e.pageX;
    startScrollLeft = carouselTestimonial.scrollLeft;
};
const dragging = (e) => {
    if (!isDragging) return;
    carouselTestimonial.scrollLeft = startScrollLeft - (e.pageX - startX);
};
const dragStop = () => {
    isDragging = false;
    carouselTestimonial.classList.remove("dragging");
};
const infiniteScroll = () => {
    if (carouselTestimonial.scrollLeft === 0) {
        carouselTestimonial.classList.add("no-transition");
        carouselTestimonial.scrollLeft = carouselTestimonial.scrollWidth - 2 * carouselTestimonial.offsetWidth;
        carouselTestimonial.classList.remove("no-transition");
    } else if (Math.ceil(carouselTestimonial.scrollLeft) === carouselTestimonial.scrollWidth - carouselTestimonial
        .offsetWidth) {
        carouselTestimonial.classList.add("no-transition");
        carouselTestimonial.scrollLeft = carouselTestimonial.offsetWidth;
        carouselTestimonial.classList.remove("no-transition");
    }
    const numberOfCards = carouselChildrens.length;
    if (numberOfCards > 3) {
        arrowBtns.forEach((btn) => {
...
const autoPlay = () => {
    ...
    timeoutId = setTimeout(() => (carouselTestimonial.scrollLeft += firstCardWidth), 2500);
};
autoPlay();
carouselTestimonial.addEventListener("mousedown", dragStart);
carouselTestimonial.addEventListener("mousemove", dragging);
document.addEventListener("mouseup", dragStop);
carouselTestimonial.addEventListener("scroll", infiniteScroll);
...
<div class="modal fade videoModal" id="videoModal" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center"> <iframe id="videoIframe" width="400" height="350" src frameborder="0"
                    allowfullscreen allow="autoplay" style="width: 100%;"></iframe> </div>
        </div>
    </div>
</div>
<script>
...
<div class="modal fade" id="videoModalSimple" tabindex="-1" aria-labelledby="myModalLabel" style="display: none;"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center"> <video width="320" height="240" controls id="simple_video" src></video>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(179, 19, 18, 1)"> Why VU?</div>
                    <div class="body_title">Vishwakarma University, Pune (VU) is a natural
                        offshoot of the Vishwakarma Group of Institutions’ educational
                        legacy spanning more than 40 years. The learning model at
                        Vishwakarma University is the combination of knowing, practicing,
                        performing, and reflecting. Through a contemporary curriculum and
                        ecosystem of holistic development, the university aims to prepare
                        learners for fulfilling career paths.</div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="count">
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(179, 19, 18, 1)">Life
            @ VU</h1>
        <div class="vu_prev_next_container"><button id="vu_prev"><img src="./global_img/life_of_vu_arrow.png"
                    style="max-width: 100%;transform: rotate(180deg);" /></button>

            <button id="vu_next"><img src="./global_img/life_of_vu_arrow.png" style="max-width: 100%" /></button>
