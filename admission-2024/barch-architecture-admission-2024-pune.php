...
<head>
    ...
    <title>Bachelor of Architecture (BArch) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(191, 105, 4, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(191, 105, 4, 0.5) 0%, rgba(191, 105, 4, 0.5) 100%),
url("./global_img/B.Arch_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Build Your Dreams, Build Your Future</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Architecture (BArch)</p>
                        <!-- <p class='second' style='font-size: 48px;'>(BArch)</p> -->
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(191, 105, 4, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(191, 105, 4, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(191, 105, 4, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(191, 105, 4, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(191, 105, 4, 1)'>Programme Overview</h1>
            <p>Council of Architecture (COA) approved BArch Programme at VU provides students with a comprehensive
                knowledge, skills, and competencies in architecture, preparing them for professional practice in the
                field.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Arch_img/key_1.png" />
                        <p>Application-Based Teaching</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Arch_img/key_2.png" />
                        <p>Internships</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Arch_img/key_3.png" />
                        <p>Workshops </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Arch_img/key_4.png" />
                        <p>Field Studies </p>
                    </div>
                </div>
            </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(191, 105, 4, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/ph_1.png" />
                    <h1 class="title">Employability & Skills Enhancement</h1>
                    <p class="title_body">The academic structure promotes skill enhancement and improves employability,
                        supported by various electives like software simulation, human psychology & construction
                        by-laws.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/ph_2.png" />
                    <h1 class="title">Real-World Applications</h1>
                    <p class="title_body">Understanding the application of knowledge in real-world scenarios and
                        hands-on training on advanced building energy modelling software, IES & exposure is achieved by
                        working on real projects.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/ph_3.png" />
                    <h1 class="title">Dynamic & Future-Oriented Curriculum</h1>
                    <p class="title_body">The curriculum is dynamically adapted to stay relevant to the changing
                        technological, social, cultural, and economic environments of the nation.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/ph_4.png" />
                    <h1 class="title">Skill-Based Add-On Courses</h1>
                    <p class="title_body">National and international level workshops, lectures from renowned architects,
                        and international collaborations provide exposure to new trends, advanced computer skills and
                        onsite execution.</p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(191, 105, 4, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_1.png" />
                    <h1 class="title">Architect</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_2.png" />
                    <h1 class="title">Sustainability Consultant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_3.png" />
                    <h1 class="title">Landscape Consultant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_4.png" />
                    <h1 class="title">Interior Designer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_5.png" />
                    <h1 class="title">Urban Designer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Arch_img/career_6.png" />
                    <h1 class="title">Estimating & Costing Consultant</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(191, 105, 4, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(191, 105, 4, 1)">Life @ VU</h1>
