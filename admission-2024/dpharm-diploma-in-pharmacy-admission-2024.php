...
<head>
    ...
    <title>Diploma in Pharmacy (DPharm) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(0, 167, 157, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(0, 167, 157, 0.5) 0%, rgba(0, 167, 157, 0.5) 100%),
url("./global_img/D.Pharm_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Gain hands-on expertise in Pharmacy</p>
                        <!-- <p class='second' style='font-size: 48px;'>Diploma in Pharmacy</p> -->
                        <p class='second' style='font-size: 48px;'>Diploma in Pharmacy (DPharm)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(0, 167, 157, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(0, 167, 157, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(0, 167, 157, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(0, 167, 157, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(0, 167, 157, 1)'>Programme Overview</h1>
            <p>The programme provides students with foundational knowledge and practical skills necessary to provide
                safe, effective, and compassionate pharmaceutical care to patients and support the delivery of quality
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/D.Pharm_img/key_1.png" />
                        <p>Understanding Medications </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/D.Pharm_img/key_2.png" />
                        <p> Dispensing and Compounding Skills </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/D.Pharm_img/key_3.png" />
                        <p>Pharmacy Management & Administration</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/D.Pharm_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(0, 167, 157, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/ph_1.png" />
                    <h1 class="title">Practical Skill Developments</h1>
                    <p class="title_body">Extensive laboratory instruction </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/ph_2.png" />
                    <h1 class="title">Clinical Exposure</h1>
                    <p class="title_body">Internship opportunities at hospitals, clinics, or community pharmacies</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/ph_3.png" />
                    <h1 class="title">Focused Curriculum</h1>
                    <p class="title_body">Comprehensive core education in pharmaceutical sciences within a relatively
                        short duration</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/ph_4.png" />
                    <h1 class="title">Pathway for Future Education </h1>
                    <p class="title_body">Graduate and Post Graduate studies, professional certificate courses, and
...
<div class="career_opportunity">
    <h1 style="color:rgba(0, 167, 157, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_1.png" />
                    <h1 class="title">Pharmacy Technician</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_2.png" />
                    <h1 class="title">Hospital / Retail Pharmacy Assistant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_3.png" />
                    <h1 class="title">Clinical Research Coordinator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_4.png" />
                    <h1 class="title">Pharmacy Technology Specialist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_5.png" />
                    <h1 class="title">Healthcare Assistant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/D.Pharm_img/career_6.png" />
                    <h1 class="title">Medical Writer</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(0, 167, 157, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(0, 167, 157, 1)">Life @ VU</h1>
