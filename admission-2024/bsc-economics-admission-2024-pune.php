...
<head>
    ...
    <title>Bachelor of Science (Economics) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(71, 29, 42, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(71, 29, 42, 0.5) 0%, rgba(71, 29, 42, 0.5) 100%),
url("./global_img/BSC-Economics_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Unlock Your Financial Potential</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Science (Economics)</p>
                        <!-- <p class='second' style='font-size: 48px;'>B.Sc. Economics</p> -->
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(71, 29, 42, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(71, 29, 42, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(71, 29, 42, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(71, 29, 42, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(71, 29, 42, 1)'>Programme Overview</h1>
            <p>The programme aims at providing students with skill-based essential knowledge in the fields of Economics
                along with Statistical and Mathematical tools. It prepares students to objectively analyse the economy,
                business, public policy, and society.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BSC-Economics_img/key_1.png" />
                        <p>Enriched Programme Structure</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BSC-Economics_img/key_2.png" />
                        <p>Interdisciplinary Approach</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BSC-Economics_img/key_3.png" />
                        <p>Applied Skills</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BSC-Economics_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(71, 29, 42, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/ph_1.png" />
                    <h1 class="title">Holistic Understanding</h1>
                    <p class="title_body">Economic theory with a holistic understanding of contemporary trends.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/ph_2.png" />
                    <h1 class="title">Real-World Application</h1>
                    <p class="title_body">Analysis of Microeconomic theory using mathematical tools in a dynamic model.
                    </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/ph_3.png" />
                    <h1 class="title">Diverse fields</h1>
                    <p class="title_body">Emerging branches like Environmental Economics, Energy Economics, Economic
                        Journalism, etc.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/ph_4.png" />
                    <h1 class="title">Enhanced Employment opportunities</h1>
                    <p class="title_body">Special courses like Agricultural Marketing, law, Economics, and International
                        Trade Theory to extend employment opportunities even further.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(71, 29, 42, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/career_1.png" />
                    <h1 class="title">Economist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/career_2.png" />
                    <h1 class="title">Policy Advocate</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/career_3.png" />
                    <h1 class="title">Financial Analyst
                    </h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/career_4.png" />
                    <h1 class="title">Stock Market Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/career_5.png" />
                    <h1 class="title">Business Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BSC-Economics_img/carrer_6.png" />
                    <h1 class="title">Financial Risk Analyst </h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(71, 29, 42, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(71, 29, 42, 1)">Life @ VU</h1>
