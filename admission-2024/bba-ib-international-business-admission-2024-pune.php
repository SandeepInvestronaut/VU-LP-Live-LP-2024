...
<head>
    ...
    <title>Bachelor of Business Administration (International Business) | Admissions Open For 2024-2025 | Vishwakarma
        University
        Pune</title>
...
linear-gradient(0deg, rgba(142, 50, 0, 0.6) 0%, rgba(142, 50, 0, 0.6) 100%),
url("./global_img/BBA-International-business_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Seize Global Opportunities</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Business Administration</p>
                        <p class='second' style='font-size: 48px;'>(International Business)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='section_4'>
            ...
            <p>The BBA (International Business) Programme proposes to give students an understanding of the different
                business management practices found worldwide and prepare them for graduate careers working abroad or in
                organizations engaged in global business.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-International-business_img/key_1.png" />
                        <p>Corporate Shadowing & Mentoring</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-International-business_img/key_2.png" />
                        <p>Study Tours and Visits</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-International-business_img/key_3.png" />
                        <p>Internship and Projects</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BBA-International-business_img/key_4.png" />
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/ph_1.png" />
                    <h1 class="title">In-depth Knowledge</h1>
                    <p class="title_body">Understand current conceptual and theoretical models, issues, and concerns in
                        international business administration.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/ph_2.png" />
                    <h1 class="title">Enhances Skills and Competencies</h1>
                    <p class="title_body"> Understanding workplace dynamics, diversity of various countries,
                        geographical and cultural sensitivity and operating in a team.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/ph_3.png" />
                    <h1 class="title">Strategising</h1>
                    <p class="title_body">Support an organisation's integrative trade initiatives by developing and
                        implementing strategies for various cultural environments.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/ph_4.png" />
                    <h1 class="title">Real-World Learning</h1>
                    <p class="title_body">Initiatives like Corporate Shadowing & Mentoring, Entrepreneurship,
                        Co-curricular learning interactions, Thematic Workshops, Internships and Projects,
                        Interdisciplinary Studies, Social Immersion, and industry visits provide an immersive
                        experience.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_1.png" />
                    <h1 class="title">Foreign Market Research Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_2.png" />
                    <h1 class="title">Global Business Development Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_3.png" />
                    <h1 class="title">Global Supply Chain Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_4.png" />
                    <h1 class="title">Import / Export Coordinator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_5.png" />
                    <h1 class="title">International Business Consultant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BBA-International-business_img/career_6.png" />
                    <h1 class="title">International Trade Specialist</h1>
                </div>
            </div>
        </div>
    </div>
