...
<head>
    ...
    <title>Bachelor of Business Administration (BBA) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(142, 50, 0, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(142, 50, 0, 0.60) 0%, rgba(142, 50, 0, 0.6) 100%),
url("./global_img/BBA-img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Sharpen Your Business Skills </p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Business Administration (BBA)</p>
                        <!-- <p class='second' style='font-size: 48px;'>BBA</p> -->
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(142, 50, 0, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(142, 50, 0, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(142, 50, 0, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(142, 50, 0, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(142, 50, 0, 1)'>Programme Overview</h1>
            <p>BBA, One of the Top Ranked Programmes, prepares students to succeed in the competitive and dynamic field
                of business by equipping them with the necessary knowledge, skills, attitude and by nurturing their
                business acumen.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_1.png" />
                        <p>Marketing</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_2.png" />
                        <p>Finance</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_3.png" />
                        <p>Human Resources</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_4.png" />
                        <p>Entrepreneurship</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_5.png" />
                        <p>Logistics and SCM</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/spc_6.png" />
    ...
    <div class="card">
        <div class="card-body">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/key_1.png" />
                        <p>Corporate Shadowing & Mentoring</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/key_2.png" />
                        <p>Study Tours and Visits</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/key_3.png" />
                        <p>Internship and Projects</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/BBA-img/key_4.png" />
                        <p> Guest Lectures & Training</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(142, 50, 0, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/ph_1.png" />
                    <h1 class="title">Wide Knowledge Base</h1>
                    <p class="title_body">Understand theoretical and functional aspects (operational, economical,
                        environmental, legal, global, ethical, societal, etc.) relevant to varied business domains.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/ph_2.png" />
                    <h1 class="title">Competencies & Attitude</h1>
                    <p class="title_body">Confidently perform distinct managerial roles and efficiently handle relevant
                        responsibilities in accordance with the goals, plan, timelines, and business ethics.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/ph_3.png" />
                    <h1 class="title">Outcome Orientation</h1>
                    <p class="title_body">Competently perform business affairs and transactions through digital and
                        non-digital mediums by communicating effectively with the professional fraternity. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/ph_4.png" />
                    <h1 class="title">Demonstrate Managerial Skills</h1>
                    <p class="title_body">Work collaboratively, communicate effectively, present professionally,
                        efficient reporting & documentation, etc.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(142, 50, 0, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/career_1.png" />
                    <h1 class="title">Administrator – Project, Facility</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/career_2.png" />
                    <h1 class="title">Analyst – Marketing, Financial</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/career_3.png" />
                    <h1 class="title">Consultant – Strategy, Sustainability</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/career_4.png" />
                    <h1 class="title">Executive – Sales, Operations</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BBA-img/career_5.png" />
                    <h1 class="title">Manager – Supply Chain, Retail</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(142, 50, 0, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(142, 50, 0, 1)">Life @ VU</h1>
