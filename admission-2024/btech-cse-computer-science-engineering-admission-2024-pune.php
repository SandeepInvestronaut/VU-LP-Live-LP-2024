...
<head>
    ...
    <title>B. Tech. (Computer Science Engineering) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(101, 124, 159, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(101, 124, 159, 0.5) 0%, rgba(101, 124, 159, 0.5) 100%),
url("./global_img/B.Tech(Computer-Science-Engineering)_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Code Your Dreams</p>
                        <!-- <p class='second' style='font-size: 48px;'>Bachelor of Technology </p> -->
                        <p class='second' style='font-size: 48px;'>B.Tech. (Computer Science Engineering)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(101, 124, 159, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(101, 124, 159, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(101, 124, 159, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(101, 124, 159, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(101, 124, 159, 1)'>Programme Overview</h1>
            <p>The programme equips students with a strong foundation in computer science and engineering principles,
                practices, and technologies and empowers them with the knowledge, skills, and mindset required to thrive
                in the dynamic and rapidly evolving field of technology.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Tech(Computer-Science-Engineering)_img/key_1.png" />
                        <p>Contemporary Curriculum</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Tech(Computer-Science-Engineering)_img/key_2.png" />
                        <p>Technical Skill Development</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Tech(Computer-Science-Engineering)_img/key_3.png" />
                        <p>Career Readiness</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Tech(Computer-Science-Engineering)_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(101, 124, 159, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/ph_1.png" />
                    <h1 class="title">A Blend of Theory and Practical</h1>
            ...
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/ph_2.png" />
                    <h1 class="title">Collaborations</h1>
                    <p class="title_body">Research and Project activities through various centers of excellence.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/ph_3.png" />
                    <h1 class="title">Internship Opportunities & Multiple Exchange Programmes</h1>
                    <p class="title_body">Various internship opportunities and exchange programmes with foreign
                        universities.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/ph_4.png" />
                    <h1 class="title">Interdisciplinary Courses</h1>
                    <p class="title_body">Exposure to various interdisciplinary courses to help students learn better.
                    </p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(101, 124, 159, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_1.png" />
                    <h1 class="title">Software Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_2.png" />
                    <h1 class="title">System Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_3.png" />
                    <h1 class="title">Application Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_4.png" />
                    <h1 class="title">IT Systems Administrator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_5.png" />
                    <h1 class="title">Webmaster</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/B.Tech(Computer-Science-Engineering)_img/career_6.png" />
                    <h1 class="title">Network Systems Administrator</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(101, 124, 159, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(101, 124, 159, 1)">Life @ VU</h1>
