...
<head>
    ...
    <title>B.Tech. (Artificial Intelligence & Data Science) | Admissions Open For 2024-2025 | Vishwakarma University
        Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(245, 83, 83, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(245, 83, 83, 0.5) 0%, rgba(245, 83, 83, 0.5) 100%),
url("./global_img/B.Tech(AI&DS)_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Be Future-Ready</p>
                        <p class='second' style='font-size: 40px;'>BTech (AI & DS), CSE (AI), (AI & ML)</p>
                        <p class='second' id='course_abbrevation' style='font-size: 26px;'>Bachelor of Technology -
                            Artificial Intelligence & Data Science, Computer Science & Engineering (Artificial
                            Intelligence), (Artificial Intelligence & Machine Learning)</p>
    ...
    gap: 12px;' action='registerForm.php' method='POST' onsubmit='checkForm(event)'>
                            ...
                            <div class='form-state-select'>
                                <select name="coursename" class="selectVal" id="coursename"
                                    ...
                                    <option value="29">B.Tech. (AI&DS) - Artificial Intelligence & Data Science</option>
                                    <option value="30">B.Tech. (CSE-AI&ML) - Artificial Intelligence & Machine Learning
                                    </option>
                                    <option value="31">B.Tech. (CSE-AI) - Artificial Intelligence</option>
                                </select>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(245, 83, 83, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(245, 83, 83, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(245, 83, 83, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(245, 83, 83, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(245, 83, 83, 1)'>Programme Overview</h1>
            <p>Vishwakarma University, Pune, is one of the leading state private universities in Pune that offers B.Tech
                in AI, AI & ML, and AIDS. This programme prepares students to apply a wide variety of cutting-edge
                technologies to equip and prepare them for different jobs in industries related to machine learning,
                artificial intelligence, and data science, as well as academic and research positions. This course will
                help students keep pace with technological changes and build critical problem-solving skills in sync
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Tech(AI&DS)_img/key_1.png" />
                        <p>Project-Based Learning</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Tech(AI&DS)_img/key_2.png" />
                        <p>Placement Assistance</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Tech(AI&DS)_img/key_3.png" />
                        <p>Research and Project Activities</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.Tech(AI&DS)_img/key_4.png" />
                        <p>Internships</p>
                    </div>
                </div>
            </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(245, 83, 83, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/ph_1.png" />
                    <h1 class="title">Crack Complex Problems</h1>
                    <p class="title_body">Apply the knowledge of engineering, data science fundamentals, and artificial
                        intelligence to solve complex engineering problems.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/ph_2.png" />
                    <h1 class="title">Identify & Design</h1>
                    <p class="title_body">Identify, formulate, and analyse complex engineering problems to create
                        solutions using the first principles of mathematics, statistics, and data science.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/ph_3.png" />
                    <h1 class="title">Adopt and Communicate</h1>
                    <p class="title_body">Execute work functions effectively as a team and individuals ethically and
                        communicate well.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/ph_4.png" />
                    <h1 class="title">Develop Technological Abilities</h1>
                    <p class="title_body">Develop learning mechanisms; demonstrate an ability to lead projects and build
                        cost models in an interdisciplinary professional setting.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(245, 83, 83, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_1.png" />
                    <h1 class="title">Application Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_2.png" />
                    <h1 class="title">Software Engineer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_3.png" />
                    <h1 class="title">System Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_4.png" />
                    <h1 class="title">Chief Technology Officer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_5.png" />
                    <h1 class="title">Web Administrator</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Tech(AI&DS)_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(245, 83, 83, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(245, 83, 83, 1)">Life @ VU</h1>
