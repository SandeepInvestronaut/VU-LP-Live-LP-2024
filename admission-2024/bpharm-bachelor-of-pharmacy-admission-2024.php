...
<head>
    ...
    <title>Bachelor of Pharmacy (BPharm) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(214, 28, 78, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(215 105 135 / 50%) 0%, rgba(215 105 135 / 50%) 100%),
url("./global_img/B.pharm_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Gateway To A Rewarding Career In Pharmacy</p>
                        <!-- <p class='second' style='font-size: 46px;'>Bachelor of Pharmacy</p> -->
                        <p class='second' style='font-size: 46px;'>Bachelor of Pharmacy (BPharm)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(214, 28, 78, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(214, 28, 78, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(214, 28, 78, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(214, 28, 78, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(214, 28, 78, 1)'>Programme Overview</h1>
            <p>A Pharmacy Council of India (PCI) approved BPharm programme aims to prepare students for a career in the
                pharmaceutical industry, healthcare sector, or related fields by building technical and managerial
                capabilities to meet the needs of industry and society.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.pharm_img/key_1.png" />
                        <p>Comprehensive Education</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.pharm_img/key_2.png" />
                        <p>Professional Recognition</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.pharm_img/key_3.png" />
                        <p>Clinical Training</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.pharm_img/key_4.png" />
                        <p>Nurtures Entrepreneurial Aspirations</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(214, 28, 78, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/ph_1.png" />
                    <h1 class="title">Capacity Building & Multispecialisation Options</h1>
                    <p class="title_body">The academic structure supports capacity building and skill enhancement with
                        varied specialization options.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/ph_2.png" />
                    <h1 class="title">Aligned with the Industry</h1>
                    <p class="title_body">Aligned with industry practices, emerging technologies, and the evolving
                        expectations of the key stakeholders.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/ph_3.png" />
                    <h1 class="title">Abreast of the Changing World</h1>
                    <p class="title_body">Relevant to the changing technological, social, cultural, and economic
                        environment of the nation.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/ph_4.png" />
                    <h1 class="title">Varied Pedagogical Approaches</h1>
                    <p class="title_body">Learning through diverse pedagogical approaches.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(214, 28, 78, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_1.png" />
                    <h1 class="title">Analytical Chemist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_2.png" />
                    <h1 class="title">R&D Scientist</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_3.png" />
                    <h1 class="title">Clinical Researcher</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_4.png" />
                    <h1 class="title">Drug Inspector</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_5.png" />
                    <h1 class="title">Food & Drug Administration Officer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.pharm_img/career_6.png" />
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(214, 28, 78, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(214, 28, 78, 1)">Life @ VU</h1>
