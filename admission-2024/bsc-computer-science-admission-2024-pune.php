...
<head>
    ...
    <title>Bachelor of Science (Computer Science) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(121, 143, 42, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(121, 143, 42, 0.5) 0%, rgba(121, 143, 42, 0.5) 100%),
url("./global_img/B.Sc-ComputerScience_img/hero_img.jpeg");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Level Up For Top Tech Careers</p>
                        <!-- <p class='second' style='font-size: 48px;'>Bachelor of Science </p> -->
                        <p class='second' style='font-size: 48px;'>Bachelor of Science (Computer Science)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(121, 143, 42, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(121, 143, 42, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(121, 143, 42, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(121, 143, 42, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(121, 143, 42, 1)'>Programme Overview</h1>
            <p>The programme provides strong knowledge, skills, and insight into the world of computers and their
                applications through professional engagements.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc-ComputerScience_img/key_1.png" />
                        <p>Comprehensive Curriculum </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc-ComputerScience_img/key_2.png" />
                        <p>Hands-On Learning </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc-ComputerScience_img/key_3.png" />
                        <p>Contemporary Teaching Pedagogies</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/B.Sc-ComputerScience_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(121, 143, 42, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/ph_1.png" />
                    <h1 class="title">Internships and Co-op Opportunities:</h1>
                    <p class="title_body">Practical experience, networking opportunities on real-world projects, in
                        industry settings.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/ph_2.png" />
                    <h1 class="title">Expert Faculty</h1>
                    <p class="title_body">A well-qualified, trained faculty that guides academics, higher studies,
                        research, and placement of all students.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/ph_3.png" />
                    <h1 class="title">Stay Ahead Of The Trends</h1>
                    <p class="title_body">Exposure to emerging trends and technologies; facilitate growth that
                        strengthens the knowledge base and the students foundation. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/ph_4.png" />
                    <h1 class="title">Elective Options</h1>
                    <p class="title_body">Provide the option of elective courses on the latest industry trends such as
                        Data Science, Mobile Computing, AR/VR, and Gaming for specialisation.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(121, 143, 42, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_1.png" />
                    <h1 class="title">Programmer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_2.png" />
                    <h1 class="title">Software Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_3.png" />
                    <h1 class="title">Multimedia Programmer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_4.png" />
                    <h1 class="title">Mobile App Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_5.png" />
                    <h1 class="title">Website Developer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.Sc-ComputerScience_img/career_6.png" />
                    <h1 class="title">IT Consultant</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(121, 143, 42, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(121, 143, 42, 1)">Life @ VU</h1>
