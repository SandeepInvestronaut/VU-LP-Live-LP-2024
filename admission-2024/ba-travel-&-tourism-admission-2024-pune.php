...
<head>
    ...
    <title>Bachelor of Arts (Travel & Tourism)| Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
        ...
        <div class='container-fluid'>
            <header class='d-flex flex-wrap justify-content-around align-items-center'>
                ...
                <ul class='nav nav-pills'>
                    <p style='color:rgba(109, 46, 16, 1)'>Call Us <span><a
...
linear-gradient(0deg, rgba(109, 46, 16, 0.5) 0%, rgba(109, 46, 16, 0.5) 100%),
url("./global_img/BA(Travel-Tourism)_img/hero_img.png");
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Travel, Learn & Earn a Rewarding Career</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:rgba(109, 46, 16, 1)'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid rgba(109, 46, 16, 1) !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:rgba(109, 46, 16, 1)'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:rgba(109, 46, 16, 1)'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:rgba(109, 46, 16, 1)'>Programme Overview</h1>
            <p>The undergraduate degree programme aims to provide students with crucial skills and industry knowledge
                relevant to an exciting range of careers within the Tourism sector, which has become a significant
                economic activity globally and is one of the fastest-growing industries that demands a professional
                outlook.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Travel-Tourism)_img/key_1.png" />
                        <p>Industry Collaborations</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Travel-Tourism)_img/key_2.png" />
                        <p>Project Based Learning</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Travel-Tourism)_img/key_3.png" />
                        <p>Field Trips & Events</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA(Travel-Tourism)_img/key_4.png" />
                        <p>Passion & Personal Fulfilment</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style="color:rgba(109, 46, 16, 1)">Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/ph_1.png" />
                    <h1 class="title">Industry relevant Skills</h1>
                    <p class="title_body">Practical skills and knowledge of travel, hospitality, and tourism.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/ph_2.png" />
                    <h1 class="title">Experience</h1>
                    <p class="title_body"> Internships and fieldwork in real-world settings.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/ph_3.png" />
                    <h1 class="title">Diverse Career Opportunities</h1>
                    <p class="title_body">Event planning, tour operations, travel agencies, destination marketing,
                        airlines, cruise lines, and more.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/ph_4.png" />
                    <h1 class="title">Global Perspective</h1>
                    <p class="title_body">International travel trends, cultural differences, and global tourism markets.
                    </p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style="color:rgba(109, 46, 16, 1)">Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_1.png" />
                    <h1 class="title">Tourism Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_2.png" />
                    <h1 class="title">Travel Guide</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_3.png" />
                    <h1 class="title">Travel Consultant</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_4.png" />
                    <h1 class="title">Travel Executive</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_5.png" />
                    <h1 class="title">Travel Blogger</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA(Travel-Tourism)_img/career_6.png" />
                    <h1 class="title">Customer Service Manager</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style="color:rgba(109, 46, 16, 1)"> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style="color:rgba(109, 46, 16, 1)">Life @ VU</h1>
