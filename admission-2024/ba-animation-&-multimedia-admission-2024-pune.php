...
<head>
    ...
    <title>BA - Animation & Multimedia | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
...
linear-gradient(0deg, rgb(142 46 106 / 50%) 0%, rgb(142 46 106 / 50%) 100%), url("./global_img/BA_Animation_img/hero_section_bg.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Make Your Mark In The World Of Animation</p>

                        <p class='second' style='font-size: 50px;'>Bachelor of Arts</p>
                        <p class='second' style='font-size: 50px;'>(Animation & Multimedia)</p>
...
display: flex;width: 100%;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:#8e2e6a'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid #8e2e6a !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div style='background-color:#8e2e6a' class='package_box'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div style='background-color:#8e2e6a' class='recruiters_box'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:#8e2e6a'>Programme Overview</h1>
            <p>The programme provides a comprehensive education in animation, multimedia, and related technologies,
                leading to careers in various creative industries, including animation studios, film production,
                advertising, gaming, and interactive media. </p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA_Animation_img/key_1.png" />


                        <p>Robust Academic Framework</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA_Animation_img/key_2.png" />
                        <p>Professional Exposures</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA_Animation_img/key_3.png" />
                        <p>Portfolio Development </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/BA_Animation_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style='color:#8e2e6a'>Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/ph_1.png" />
                    <h1 class="title">Lucrative Career Options</h1>
                    <p class="title_body">Pursue lucrative careers as 2D & 3D modellers, animators, art directors,
                        visualizers in advertising agencies, web designing, game asset designing, e-learning artists,
                        etc. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/ph_2.png" />
                    <h1 class="title">One-on-One Interaction</h1>
                    <p class="title_body">Interact with Faculty and Subject Matter Experts, who have worked on projects
                        that have been acclaimed both nationally and internationally. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/ph_3.png" />
                    <h1 class="title">UNITY Technology Collaboration</h1>
                    <p class="title_body">Collaboration with UNITY Technologies to set up the Vishwakarma Unity Center
                        of Excellence (VCOE) in Immersive Technologies (Augmented Reality, Virtual Reality, and Mixed
                        Reality) & Tools. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/ph_4.png" />
                    <h1 class="title">All-Round Approach</h1>
                    <p class="title_body">Holistic training that allows students to thrive and develop the right
                        skillset. </p>
                </div>
            </div>
        </div>
...
<div class="career_opportunity">
    <h1 style='color:#8e2e6a'>Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_1.png" />
                    <p class="title">2D / 3D Motion Graphics Animator</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_2.png" />
                    <p class="title">Graphic Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_3.png" />
                    <p class="title">Multimedia Artist</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_4.png" />
                    <p class="title">Pre-Production Artist</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_5.png" />
                    <p class="title">VFX Artist</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/BA_Animation_img/career_6.png" />
...
<div class="testimonials">
    <h1 style='color:#8e2e6a'>Testimonial</h1>
            ...
            <div class="container-fluid">
                <div class="wrapper"><i id="left" class="fa-solid fa-angle-left" style="display:none;"></i>
                    <ul class="carousel_Testimonial">
                        <li class="card" style="background-color: #8e2e6a;">
                            <div class="embed-responsive embed-responsive-16by9"><img
                                    src="./global_img/BA_Animation_img/thubnail.png" alt="VU Campus"
                                    class="card-img-top image-fluid"
                                    onclick="playVideo('https://www.youtube.com/embed/kNzpPun58RA')"></div>
                        </li>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style='color:#8e2e6a'> Why VU?</div>
