...
<head>
    ...
    <title>MBA | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
    ...
    <!-- <script src="https://eequeuestorage.blob.core.windows.net/staticfiles/vupune/ee-form-widget/form-2/widget.js"></script> -->
...
linear-gradient(0deg, rgb(0 78 71 / 50%) 0%, rgb(0 78 71 / 50%) 100%), url("./global_img/MBA_img/hero_img.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Level Up Your Career</p>
                        <p class='second' style='font-size: 48px;'>Master of Business Administration</p>
                        <p class='second' style='font-size: 48px;'>(MBA)</p>
                        <p class='third'>2 Years | 4 Semesters</p>
...
width: 100%;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='section_4'>
            ...
            <p>The MBA programme at VU builds a holistic perspective through a dynamic learning model and practical
                experience. The MBA course structure provides students with the best corporate exposure. The focus is on
                developing analytical and interpersonal skills with data management and diagnostic problem-solving
                skills essential for managerial and business decision-making.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_1.png" />
                        <p>Marketing</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_2.png" />
                        <p>Finance</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_3.png" />
                        <p>Human Resources</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_4.png" />
                        <p>International Business</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_5.png" />
                        <p>Logistics and SCM</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/spc_6.png" />
    ...
    <div class="card">
        <div class="card-body">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/key_1.png" />
                        <p>Top Placements </p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/key_2.png" />
                        <p> High Salary Packages </p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/key_3.png" />
                        <p>Outcome-Based Education </p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/MBA_img/key_4.png" />
                        <p>Industry Connect Initiatives</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/ph_1.png" />
                    <h1 class="title">Exponential Learning</h1>
                    <p class="title_body">Distinctive approach to learning through Research, Innovation,
                        Entrepreneurship and New-age technologies.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/ph_2.png" />
                    <h1 class="title">Future-proof your career</h1>
                    <p class="title_body">Engine for exceptional analytical, thinking and leadership skills with a
                        global mindset for career transformation.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/ph_3.png" />
                    <h1 class="title">Work Integrated Learning</h1>
                    <p class="title_body">Flexibility & Convenience to self-pace career enhancement, keeping
                        professional commitments.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/ph_4.png" />
                    <h1 class="title">Plug into Diversity</h1>
                    <p class="title_body">Access to a rich network of professionals to benefit from perspectives,
                        mentoring and progressive outlook.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_1.png" />
                    <p class="title">Financial Analyst</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_2.png" />
                    <p class="title">Human Resources Manager</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_3.png" />
                    <p class="title">Project Manager</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_4.png" />
                    <p class="title">Business Development Manager</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_5.png" />
                    <p class="title">Management Consultant</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/MBA_img/career_6.png" />
