...
<head>
    ...
    <title>B.F. Tech (Fashion Technology) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
...
linear-gradient(0deg, rgba(15 117 107 / 12%) 0%, rgba(15 117 107 / 25%) 100%), url("./global_img/B.F.Tech_img/hero_img.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Passion for Fashion</p>
                        <p class='second' style='font-size: 50px;'>Bachelor of Fashion Technology</p>
                        <p class='second' style='font-size: 50px;'>(B.F. Tech)</p>
...
width: 100%;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='section_4'>
            ...
            <p>The programme provides a well-rounded education to navigate through the diverse and dynamic landscape of
                the fashion industry and pursue careers in design, production, marketing, retail, or entrepreneurship by
                imbibing creativity, professionalism, and modern technical practices.</p>
        ...
        <div class="card-body">
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.F.Tech_img/key_1.png" />
                        <p>Design Proficiency </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.F.Tech_img/key_2.png" />
                        <p>Technological Competence</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.F.Tech_img/key_3.png" />
                        <p>Projects & Internship </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img src="./global_img/B.F.Tech_img/key_4.png" />
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/ph_1.png" />
                    <h1 class="title">Career Opportunities</h1>
                    <p class="title_body">Prepare for exciting careers in the Fashion Industry.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/ph_2.png" />
                    <h1 class="title">Interpret Innovations</h1>
                    <p class="title_body">Understand the present-day developments in terms of technology and creative
                        innovations in the Fashion Industry.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/ph_3.png" />
                    <h1 class="title">Creative Learning Culture</h1>
                    <p class="title_body">Develop the skill set to work in the collaborative dynamics of a design team
                        and artisans.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/ph_4.png" />
                    <h1 class="title">Entrepreneurship Skills</h1>
                    <p class="title_body">Launch a creative future by learning entrepreneurial skills that lead to
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_1.png" />
                    <p class="title">Fashion Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_2.png" />
                    <p class="title">Fashion Stylist</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_3.png" />
                    <p class="title">Production Controller</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_4.png" />
                    <p class="title">Fashion Photographer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_5.png" />
                    <p class="title">Fashion Director</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/B.F.Tech_img/career_6.png" />
                    <p class="title">Fashion Curator</p>
                </div>
            </div>
        </div>
    </div>
