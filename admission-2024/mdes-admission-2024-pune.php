...
<head>
    ...
    <title>Master of Design (M.Des.) | Admissions Open For 2024-2025 | Vishwakarma University Pune</title>
...
linear-gradient(0deg, rgb(126 37 83 / 50%) 0%, rgb(126 37 83 / 50%) 100%), url(./global_img/M.Des_img/hero_img.jpeg); background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Advance Your Design Journey</p>
                        <p class='second' style='font-size: 48px;'>Master of Design (M.Des.)</p>
...
padding: 30px 100px;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            <h1 style='color:#7e2553;'>Industry Connect</h1>
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>

                    <div class='card slider_container' style="border: 1px solid #7e2553 !important;">
                ...
                <div class='col-sm-6 col-md-6 p-0'>
                    <div class='card pacakge_container'>
                        <div class='card-body'>
                            <div class='package_box' style='background-color:#7e2553;'>
                                <p class='number'>17.75<sup>LPA*</sup></p>
                                <p class='text'>Highest Package</p>
                            </div>
                            <div class='recruiters_box' style='background-color:#7e2553;'>
        ...
        <div class='section_4'>
            ...
            <h1 style='color:#7e2553;'>Programme Overview</h1>
            <p>The Master of Design (M.Des.) programme aims at developing a holistic approach toward design by equipping
                the graduates with advanced skills and knowledge in the design field. The programme focuses on
                developing Logical Thinking, Project Management, Research Skills, Presentation and Communication Skills,
                Attention to Detail, and Critical thinking.</p>
        ...
        <div class="card-body">
            ...
            <div class="Specialisations_fields">
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/spc_1.png" />
                        <p>Visual Communication</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/spc_2.png" />
                        <p>Product Design</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/spc_3.png" />
    ...
    <div class="card">
        <div class="card-body">
            <div class="key_advantages">
                <p>Key Advantages</p>
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/key_1.png" />
                        <p>Hands on Experience </p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/key_2.png" />
                        <p>Multidisciplinary Approach</p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/key_3.png" />
                        <p>Cutting age Tools & Technologies
                        </p>
                    </div>
                    <div class="col-sm-6 col-sm-6 pt-4 pb-5 p-4"><img src="./global_img/M.Des_img/key_4.png" />
...
<div class="programme_highlights">
    <div class="container-fluid">
        <p class="programme_highlights_title" style='color:#7e2553;'>Programme Highlights</p>
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/ph_1.png" />
                    <h1 class="title">Industry-Academia Partnership</h1>
                    <p class="title_body">Gain practical knowledge with interactions and collaborations with industry
                        professionals.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/ph_2.png" />
                    <h1 class="title">Real-world Application</h1>
                    <p class="title_body">Design seamless products (digital and physical) and user-friendly systems that
                        spark professional interest. </p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/ph_3.png" />
                    <h1 class="title">Professional Design Practices</h1>
                    <p class="title_body">Learn the latest industry practices and utilise them to solve problems
                        creatively, from concept to delivery.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/ph_4.png" />
...
<div class="career_opportunity">
    <h1 style='color:#7e2553;'>Career Opportunities</h1>
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_1.png" />
                    <h1 class="title">Design Analyst</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_2.png" />
                    <h1 class="title">Brand Designer</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_3.png" />
                    <h1 class="title">Design Manager</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_4.png" />
                    <h1 class="title"> Creative Director</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_5.png" />
                    <h1 class="title">Design Researcher</h1>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img src="./global_img/M.Des_img/career_6.png" />
                    <h1 class="title">Experience Designer</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-6">
                <div class="body_wrapper">
                    <div class="title" style='color:#7e2553;'> Why VU?</div>
...
<div class="life_Of_vu">
    <div class="container-fluid" style="padding-left: 0 !important; padding-right: 0 !important;">
        <h1 style='color:#7e2553;'>Life @ VU</h1>
