...
<head>
    ...
    <title>Bachelor of Arts (Interior Design & Decoration) | Admissions Open For 2024-2025 | Vishwakarma University Pune
    </title>
...
linear-gradient(0deg, rgb(0 76 70 / 50%) 0%, rgb(0 76 70 / 50%) 100%), url("./global_img/BA_Interior_design_decoration_img/hero_bg.png");background-repeat: no-repeat;
            ...
            <div class='hero_section row d-flex align-items-center justify-content-between'>
                <div class='col-sm-6 col-md-6'>
                    <div class='hero_bg_image'>
                        <p class='first'>Turn Your Passion For Design Into Profession</p>
                        <p class='second' style='font-size: 48px;'>Bachelor of Arts</p>
                        <p class='second' style='font-size: 48px;'>(Interior Design & Decoration)</p>
...
width: 100%;'>
    ...
    <div class='order_wrapper'>
        ...
        <div class='industry_connect container-fluid'>
            ...
            <div class='row'>
                <div class='col-sm-6 col-md-6 mb-responsive'>
                    ...
                    <div class='card slider_container style="border: 1px solid rgba(197, 127, 30, 1) !important;"'>
        ...
        <div class='section_4'>
            ...
            <p>The programme produces graduates who are well-prepared to enter the professional world of interior
                design, equipped with the skills and knowledge necessary to create functional, aesthetically pleasing,
                and sustainable interior spaces.</p>
            ...
            <div class="key_advantages">
                ...
                <div class="row justify-content-evenly text-center align-items-center">
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA_Interior_design_decoration_img/key_1.png" />
                        <p>Application-Based Teaching </p>

                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA_Interior_design_decoration_img/key_2.png" />
                        <p>Internships </p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA_Interior_design_decoration_img/key_3.png" />
                        <p>Workshops</p>
                    </div>
                    <div class="col-sm-3 col-sm-3 pt-4 pb-5 p-4"><img
                            src="./global_img/BA_Interior_design_decoration_img/key_4.png" />
                        <p>Field Studies</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center align-items-stretch gap-5">
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/ph_1.png" />
                    <h1 class="title">Enhanced Problem-Solving Skills</h1>
                    <p class="title_body">Obtain a combination of problem-solving skills and creativity and practice
                        learning by incorporating real-life requirements.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/ph_2.png" />
                    <h1 class="title">Workshops & Webinars</h1>
                    <p class="title_body">Workshops and guest lectures by industry experts and academicians. Webinars by
                        alumni and industry experts.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/ph_3.png" />
                    <h1 class="title">Hands-on Approach</h1>
                    <p class="title_body">Hands-on learning and block teaching with mentoring by the top professionals
                        from the world of interior design.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 p-0 ph_box">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/ph_4.png" />
                    <h1 class="title">Focus on Career</h1>
                    <p class="title_body">Focus on employability skills is integrated through the curriculum, right from
    ...
    <div class="container-fluid p-1">
        <div class="row justify-content-center" style="text-align: center;align-items: center;">
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_1.png" />
                    <p class="title">Interior Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_2.png" />
                    <p class="title">Visual Merchandiser</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_3.png" />
                    <p class="title">Design Manager</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_4.png" />
                    <p class="title">Exhibition Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_5.png" />
                    <p class="title">Set Designer</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-3 pt-3 pb-3">
                <div class="programmer_body_container"><img
                        src="./global_img/BA_Interior_design_decoration_img/career_6.png" />
                    <p class="title">Design Consultant</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="carousel_Testimonial">
                        <li class="card">
                            <div class="embed-responsive embed-responsive-16by9"><img
                                    src="./global_img/BA_Interior_design_decoration_img/testimonail_thmbnail.png"
                                    alt="VU Campus" class="card-img-top image-fluid"
                                    onclick="playVideo('https://www.youtube.com/embed/-_voMTXHEE0')"></div>
                        </li>
